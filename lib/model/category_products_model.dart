...
class ProductModel{
  ...
  ProductModel({this.status, this.message, this.data, this.meta, this.link});
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    try {
      ...
      products ??=[];
      products!.removeWhere((element) => element.variants!.isEmpty);
    } catch (e) {
      products ??= [];
    }
    products ??= [];
...
class Products {
  ...
  Products({this.id, this.categoryId, this.sKU, this.avgRating, this.name, this.whislist, this.image, this.variants});
