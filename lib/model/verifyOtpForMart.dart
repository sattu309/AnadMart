class VerityOtpModel {
  bool? status;
  String? message;
  String? authToken;
  Data? data;

  VerityOtpModel({this.status, this.message, this.authToken, this.data});

  VerityOtpModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data({this.userData, this.notificationCount});
